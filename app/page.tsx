        ...
        <div className="md:col-span-9 space-y-8">
          ...
          <section className="">
            <div className="grid grid-cols-2 gap-4 h-40">
              <div className="bg-bg-component text-title flex items-center justify-center p-10 rounded-main text-text-primary">
                PORTFOLIO
              </div>
              <div className="bg-linear-to-b from-[#CBC4D3] to-[#CED2E2] dark:bg-linear-to-b dark:from-[#4C5471] dark:to-[#6D627C] text-title flex items-center justify-center p-10 rounded-main">
                GITHUB
              </div>
            </div>
          </section>
